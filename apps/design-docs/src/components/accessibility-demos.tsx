...
import { Button, Input, Checkbox, Label } from "@nebutra/ui/primitives";
import { ComponentPreview } from "@/components/component-preview";
import { Loader2, X, AlertCircle, CheckCircle as CheckCircleIcon, XCircle } from "lucide-react";
        ...
        <ComponentPreview>
            <div className="flex flex-col items-center gap-4">
                <p className="text-sm text-fd-muted-foreground text-center max-w-[400px]">
                    The button below contains visually hidden text for screen readers using the <code className="text-xs">visuallyHidden</code> style object. Inspect the DOM to see it.
                </p>
                <Button onClick={() => setCount(c => c + 1)} className="gap-2">
                    <span>Increment</span>
                    <span style={visuallyHidden}>
                        Current count is {count}. Click to add 1.
                    </span>
        ...
        <ComponentPreview>
            <div className="flex flex-col items-center gap-6">
                <p className="text-sm text-fd-muted-foreground text-center">
                    Standard interactive elements get this focus ring via <code className="text-xs">&:focus-visible</code>. Use tab to navigate between these elements.
                </p>
        ...
        <ComponentPreview>
            <div className="flex flex-col items-center gap-8 text-center">
                <p className="text-sm text-fd-muted-foreground max-w-[400px]">
                    The icon is small (16x16), but the clickable area meets the WCAG 2.5.5 requirement of at least 44x44 pixels using <code className="text-xs">minTouchTarget</code>.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-12 sm:gap-24 items-center justify-center">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="relative border border-dashed border-green-500/50 rounded-md bg-green-500/10 p-4">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center text-[10px] text-green-600 font-medium opacity-50">44x44</div>
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="relative border border-dashed border-red-500/50 rounded-md bg-red-500/10 p-4">
                            <div className="absolute inset-0 flex items-center justify-center text-[10px] text-red-600 font-medium opacity-50">16x16</div>
    ...
    return (
        <ComponentPreview>
            <div className="flex flex-col items-center gap-6 w-full max-w-lg">
                ...
                <p className="text-sm text-fd-muted-foreground text-center">
                    When reduced motion is active, CSS transitions and long animations are instantly skipped. Try toggling the switch above and see the ball.
                </p>
        ...
        <ComponentPreview>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
                <div className="flex flex-col gap-4">
                    <div className="text-sm font-medium">Normal Text (WCAG AA: {contrastRequirements.normalText}:1)</div>
                ...
                <div className="flex flex-col gap-4">
                    <div className="text-sm font-medium">Large Text (WCAG AA: {contrastRequirements.largeText}:1)</div>
                    <div className="flex flex-col rounded-lg overflow-hidden border border-fd-border">
