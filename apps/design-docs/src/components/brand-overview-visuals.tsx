    ...
    return (
        <div className="flex flex-col gap-10 my-8">
            ...
            <div className="flex flex-col gap-4">
                <h4 className="text-lg font-semibold text-foreground border-b border-[var(--neutral-5)] pb-2">Primary Logos</h4>
            ...
            <div className="flex flex-col gap-4">
                <h4 className="text-lg font-semibold text-foreground border-b border-[var(--neutral-5)] pb-2">Localized Logos (Logomark + Wordmark)</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {/* EN */}
                    <MagicCard className="p-0 rounded border-[var(--neutral-5)] flex flex-col overflow-hidden bg-[var(--neutral-1)]" gradientColor="var(--neutral-3)">
            ...
            {/* Layout Variants */}
            <div className="flex flex-col gap-4">
                <h4 className="text-lg font-semibold text-foreground border-b border-[var(--neutral-5)] pb-2">Layout Variants</h4>
            ...
            {/* Components */}
            <div className="flex flex-col gap-4">
                <h4 className="text-lg font-semibold text-foreground border-b border-[var(--neutral-5)] pb-2">Interactive SVG Components</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <MagicCard className="p-0 rounded border-[var(--neutral-5)] flex flex-col overflow-hidden bg-[var(--neutral-1)]" gradientColor="var(--neutral-3)">
                        ...
                        <div className="p-3 border-t border-[var(--neutral-5)] flex justify-between items-center bg-[var(--neutral-2)]">
                            ...
                            <code className="text-[10px] text-muted-foreground font-mono">&lt;LogomarkSVG /&gt;</code>
                        </div>
                    </MagicCard>
                    ...
                    <MagicCard className="p-0 rounded border-[var(--neutral-5)] flex flex-col overflow-hidden bg-[var(--neutral-1)]" gradientColor="var(--neutral-3)">
                        ...
                        <div className="p-3 border-t border-[var(--neutral-5)] flex justify-between items-center bg-[var(--neutral-2)]">
                            ...
                            <code className="text-[10px] text-muted-foreground font-mono">&lt;WordmarkEnSVG /&gt;</code>
                        </div>
                    </MagicCard>
                </div>
            </div>
...
import { Moon, Sparkles, Lightning, Code } from "@nebutra/icons";
    ...
    return (
        <div className="my-16 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
                ...
                <h3 className="text-3xl md:text-5xl font-display font-bold tracking-tight text-foreground">Self-Referential Intelligence</h3>
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl">
                    The Nebutra visual identity is rooted in the hexagon — the most efficient tessellation found in nature. It represents structured intelligence emerging from interconnected nodes, built for absolute precision and scale.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Dark-first */}
                <MagicCard className="p-8 md:p-10 rounded-2xl border-[var(--neutral-5)] bg-[var(--neutral-1)] flex flex-col gap-4 overflow-hidden" gradientColor="var(--neutral-3)">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-base">
                        Our interfaces are designed for deep focus. Dark mode is our native state, with light mode acting as a deliberate adaptation for highly illuminated environments.
                    </p>
                </MagicCard>

                {/* Gradient Sign */}
                <MagicCard className="p-8 md:p-10 rounded-2xl border-[var(--neutral-5)] bg-[var(--neutral-1)] flex flex-col gap-4 overflow-hidden relative" gradientColor="var(--neutral-3)">
                    {/* Subtle gradient orb */}
                    ...
                    <p className="text-muted-foreground leading-relaxed text-base relative z-10">
                        We use a precise Blue-to-Cyan gradient sparingly to indicate high-value actions, brand moments, and critical AI interventions.
                    </p>
                </MagicCard>
                ...
                <MagicCard className="p-8 md:p-10 rounded-2xl border-[var(--neutral-5)] bg-[var(--neutral-1)] flex flex-col gap-4 overflow-hidden" gradientColor="var(--neutral-3)">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-base">
                        Animation is never decorative. Motion represents state changes, data processing, and system intelligence. It is sharp, fast, and decisive.
                    </p>
                </MagicCard>
                ...
                <MagicCard className="p-8 md:p-10 rounded-2xl border-[var(--neutral-5)] bg-[var(--neutral-1)] flex flex-col gap-4 overflow-hidden" gradientColor="var(--neutral-3)">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-base">
                        Every spacing, color, and typography decision is tokenized. The brand is shipped as code, ensuring absolute consistency across all touchpoints.
                    </p>
                </MagicCard>
            </div>
        </div>
