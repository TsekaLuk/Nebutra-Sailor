    ...
    return (
        <div className="my-10 w-full max-w-5xl">
            ...
            <div className="mb-12 overflow-hidden rounded-xl border border-[var(--neutral-6)] shadow-sm">
                ...
                <div className="flex flex-wrap w-full sm:flex-nowrap">
                    <ColorSwatch name="Success" hex={colors.success} contrastForeground="#ffffff" className="flex-[1_1_50%] sm:flex-[1_1_0%]" />
                    <ColorSwatch name="Warning" hex={colors.warning} contrastForeground="#ffffff" className="flex-[1_1_50%] sm:flex-[1_1_0%]" />
                    <ColorSwatch name="Error" hex={colors.error} contrastForeground="#ffffff" className="flex-[1_1_50%] sm:flex-[1_1_0%]" />
                    <ColorSwatch name="Info" hex={colors.info} contrastForeground="#ffffff" className="flex-[1_1_50%] sm:flex-[1_1_0%]" />
                </div>
            </div>
        </div>
    );
