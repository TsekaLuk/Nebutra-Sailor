...
import { AlertCircle, CheckCircle, XCircle, Plus, FileText, Trash2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full my-6">
            ...
            <div className="flex flex-col rounded-lg border border-green-200 bg-green-50/50 dark:border-green-900/30 dark:bg-green-900/10 overflow-hidden">
                ...
                <div className="p-6 flex flex-col items-center justify-center py-12 text-center border mt-4 mx-4 border-dashed rounded-lg bg-fd-background">
                    ...
                    <p className="text-sm text-fd-muted-foreground mb-4 max-w-[200px]">Get started by setting up a new project space.</p>
                ...
                <div className="p-6 flex items-center justify-center bg-black/5 dark:bg-black/40">
                    <Card className="w-full shadow-lg">
                        <CardHeader className="pb-3 text-red-600">
                            <h3 className="font-semibold text-lg leading-none tracking-tight">WARNING! DELETING PROJECT</h3>
                        </CardHeader>
                        <CardContent className="pb-4">
                            <p className="text-sm text-fd-muted-foreground">
                                Are you absolutely sure you want to do this? Once you delete it, it is gone forever and you will lose everything.
                            </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 items-end">
                            <div className="space-y-2">
                                <Label className="text-xs text-fd-muted-foreground flex items-center gap-1.5"><XCircle className="w-3 h-3 text-red-500" /> Wrong (Generic)</Label>
                                <Button className="w-full">Submit</Button>
                            </div>
                            <div className="space-y-2">
                                <Label className="text-xs text-fd-muted-foreground flex items-center gap-1.5"><CheckCircle className="w-3 h-3 text-green-500" /> Correct (Verb-Noun)</Label>
                ...
                <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-fd-border">
                        <tr>
                            ...
                            <td className="py-3 px-4"><Button variant="outline" size="sm">Save Changes</Button></td>
                            <td className="py-3 px-4"><Button variant="outline" size="sm">Save changes</Button></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="py-3 px-4 flex items-center gap-2"><div className="w-4 h-4 rounded border border-primary shrink-0 flex items-center justify-center"><CheckCircle className="w-3 h-3 text-primary" /></div> Keep Me Logged In</td>
                            <td className="py-3 px-4 flex items-center gap-2"><div className="w-4 h-4 rounded border border-primary shrink-0 flex items-center justify-center"><CheckCircle className="w-3 h-3 text-primary" /></div> Keep me logged in</td>
                        </tr>
                    </tbody>
                </table>
