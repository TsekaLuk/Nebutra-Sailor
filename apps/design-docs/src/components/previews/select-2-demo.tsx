...
import { SelectValue, SelectSeparator, SelectContent, Select, SelectGroup, SelectLabel, SelectTrigger, SelectItem } from "@nebutra/ui/primitives";

export function Select2Demo() {
  return (
    <Select>
