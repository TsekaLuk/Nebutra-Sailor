...
function Swatch({
    ...
    const isLightBg =
        parseInt(shade) < 400 || shade === "50" || shade === "foreground";
            ...
            {animations.map(([key, value]) => (
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            animation: playing === key || key.includes("spin") || key.includes("pulse") || key.includes("bounce")
                                ? (value as string)
                                : "none"
                        }}
                    >
                    ...
                    <code className="text-xs font-mono text-primary font-semibold truncate w-full text-center">animate-{key}</code>
                </button>
            ))}
        </div>
    );
