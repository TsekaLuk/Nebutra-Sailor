...
<CardGroup cols={2}>
  ...
  <Card title="Fragment Components" icon="puzzle" href="/fragment-components/introduction">
    Composed UI blocks used across pages.
  </Card>
  <Card title="Atom Components" icon="circle" href="/atom-components/introduction">
