...
export default async function CookiePolicyPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <article className="prose prose-gray dark:prose-invert max-w-none">
      ...
      <p className="lead">
        <strong>{t("cookies.effectiveDate")}:</strong> January 1, 2025
        <br />
        <strong>{t("cookies.lastUpdated")}:</strong> January 1, 2025
      </p>
      ...
      <p>
        <strong>We do NOT use browser fingerprinting for tracking.</strong>
      </p>
