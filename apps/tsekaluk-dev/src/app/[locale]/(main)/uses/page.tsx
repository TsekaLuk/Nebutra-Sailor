              ...
              <div className="group relative overflow-hidden rounded-[2rem] border border-gray-100 dark:border-white/5 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-900/50 p-8 md:p-10 shadow-sm transition-all duration-500 hover:shadow-xl dark:hover:shadow-[0_0_40px_rgba(255,255,255,0.03)] hover:-translate-y-1">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-wrap items-center gap-3 mb-6">
                    <span className="font-mono text-xs tracking-widest text-gray-400 dark:text-gray-500 uppercase">Apple M4</span>
                    <span className="text-gray-300 dark:text-gray-700">·</span>
                    <span className="font-mono text-xs tracking-widest text-gray-400 dark:text-gray-500 uppercase">24 GB</span>
                    <span className="text-gray-300 dark:text-gray-700">·</span>
                    <span className="font-mono text-xs tracking-widest text-gray-400 dark:text-gray-500 uppercase">macOS 26</span>
                  </div>
                  <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    ...
                    complaint. Highly reliable and silent workstation.
                  </p>
                </div>
              </div>
            </AnimateIn>
          ...
          <div>
            <AnimateIn preset="fadeUp" delay={0.4}>
              ...
              <div className="grid grid-cols-3 gap-3">
                {AI_TOOLS.map((tool) => (
                  <div key={tool.name} className="group relative flex flex-col items-center justify-center gap-3 rounded-2xl border border-gray-100 dark:border-white/5 bg-white/50 dark:bg-gray-900/50 p-4 transition-all duration-300 hover:bg-white dark:hover:bg-gray-800 hover:border-[var(--color-accent)]/30 hover:shadow-md hover:-translate-y-1">
