...
// Omit native prefix so we can use our ReactNode prefix
  ...
  return (
    <button
      ...
      className={clsx(
        ...
        sizes[+svgOnly]?.[size] || sizes[0].medium,
        (disabled || loading) ? "bg-gray-100 text-gray-700 border border-gray-400 cursor-not-allowed" : types[buttonType],
        shapes[shape]?.[size] || shapes.square.medium,
