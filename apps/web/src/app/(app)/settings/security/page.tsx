...
export default async function SecuritySettingsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-lg border border-[var(--neutral-7)] p-6">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="mt-0.5 rounded-md bg-[var(--neutral-2)] p-2">
        ...
        {!hasMfa && (
          <div className="mt-4">
            <a
              ...
              className="inline-flex items-center rounded-md border border-[var(--neutral-7)] px-3 py-2 text-sm font-medium text-[var(--neutral-12)] transition-colors hover:bg-[var(--neutral-2)] focus:outline-none focus:ring-2 focus:ring-[var(--blue-9)] focus:ring-offset-1"
            >
              Enable 2FA
            </a>
          </div>
      ...
      <section className="rounded-lg border border-red-200 bg-red-50/40 p-6">
        ...
        <p className="mt-1 text-sm text-red-700">
          Deleting your account is permanent and cannot be undone. All data associated
          with your account will be removed.
        </p>
        <div className="mt-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center rounded-md border border-red-300 px-3 py-2 text-sm font-medium text-red-700 transition-colors hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-1"
          >
            Delete account
          </a>
        </div>
