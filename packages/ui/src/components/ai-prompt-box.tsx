...
import { Tooltip, TooltipProvider, TooltipTrigger, TooltipContent } from "../primitives/tooltip";
                            ...
                            >
                                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                                    <motion.div
                                        ...
                                        transition={{ type: "spring", stiffness: 260, damping: 25 }}
                                    >
                                        <BrainCog className={cn("w-4 h-4", showThink ? "text-indigo-500" : "text-inherit")} />
                                    </motion.div>
                                </div>
                                <AnimatePresence>
                                    {showThink && (
