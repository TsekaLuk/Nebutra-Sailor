...
export interface BaseBadgeProps extends useRender.ComponentProps<'span'>, VariantProps<typeof baseBadgeVariants> {
    asChild?: boolean;
    dotClassName?: string;
    disabled?: boolean;
}

export interface BaseBadgeButtonProps extends useRender.ComponentProps<'button'>, VariantProps<typeof baseBadgeButtonVariants> {
    asChild?: boolean;
}
...
function BaseBadgeButton({ render, asChild = false, children, className, variant, ...props }: BaseBadgeButtonProps) {
    const defaultProps = {
