...
const HoverCard = ({
    ...
    children,
    ...props
}: React.ComponentPropsWithoutRef<typeof BasePopover.Root> & { openDelay?: number, closeDelay?: number, children: React.ReactNode }) => {
    ...
    return (
        <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="inline-block relative">
            <BasePopover.Root open={open} onOpenChange={(v) => {
...
const HoverCardTrigger: React.ForwardRefExoticComponent<
    React.ComponentPropsWithoutRef<typeof BasePopover.Trigger> & { asChild?: boolean } & React.RefAttributes<React.ElementRef<typeof BasePopover.Trigger>>
> = React.forwardRef<
...
>(({ asChild, children, ...props }, ref) => {
    if (asChild && React.isValidElement(children)) {
        return (
            <BasePopover.Trigger ref={ref} {...props} render={children as React.ReactElement<Record<string, unknown>>} />
        );
    }
    return (
...
const HoverCardContent = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof BasePopover.Popup> & { align?: "start" | "center" | "end", sideOffset?: number, side?: "top" | "right" | "bottom" | "left" }
