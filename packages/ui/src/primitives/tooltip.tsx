...
const Tooltip = ({ delayDuration, children, ...props }: React.ComponentPropsWithoutRef<typeof BaseTooltip.Root> & { delayDuration?: number, children?: React.ReactNode }) => {
...
>(({ asChild, children, ...props }, ref) => {
  if (asChild && React.isValidElement(children)) {
    return (
      <BaseTooltip.Trigger ref={ref} {...props} render={children as React.ReactElement<Record<string, unknown>>} />
    );
  }
  return (
...
const TooltipContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof BaseTooltip.Popup> & { side?: "top" | "right" | "bottom" | "left", align?: "start" | "center" | "end", sideOffset?: number, alignOffset?: number }
>(({ className, side = "top", align = "center", sideOffset = 4, alignOffset = 0, ...props }, ref) => (
  <BaseTooltip.Portal>
